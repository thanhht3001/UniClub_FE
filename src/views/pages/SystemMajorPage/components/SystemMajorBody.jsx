...
export default function SystemMajorBody(props) {
            ...
            <Card style={{ paddingBottom: '10px' }}>
              <CardHeader className="border-0">
                <Row className="align-items-center">
                  <div className="col">
                    <h3 className="mb-0">Khối ngành</h3>
                  </div>
                ...
                {props.data ? (
                  <Table className="align-items-center table-flush" responsive>
                    <thead className="thead-light">
                      <tr>
                        <th scope="col">STT</th>
                        <th scope="col">Tên khối ngành</th>
                    ...
                    <Pagination className="pagination justify-content-end mb-0" listClassName="justify-content-end mb-0">
                      <PaginationItem className={props.data.has_previous === false ? 'disabled' : ''}>
                        <PaginationLink
                          ...
                          onClick={(e) => {
                            e.preventDefault();
                            props.loadMajorList(search, props.data.current_page - 1);
                          }}
                        >
