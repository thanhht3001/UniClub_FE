  ...
  async function createCompetition() {
    ...
    if (checkValidation()) {
      if (localStorage && localStorage.getItem('accessToken')) {
        ...
        warningAlert('Xác minh tài khoản thất bại! Vui lòng đăng nhập lại');
      }
    }
    setFormModal(false);
  }
            ...
            <Card className="card-wrapper" lg="4" style={{ position: 'sticky', top: '10px' }}>
              ...
              <CardBody>
                <Row>
                  <Col className="col-auto">
                    <h3>
                      Chọn chuyên ngành: <span className="text-gray text-sm">(Để trống để chọn tất cả)</span>
                    </h3>
                  </Col>
                </Row>
                <Row className="mb-4">
                ...
                <Row className="mb-4">
                  <Col>
                    <InputGroup>
                      <Input type="number" min={0} value={seedPoint} max={100} onChange={(e) => setSeedPoint(e.target.value)} />
                      <InputGroupAddon addonType="append">
                        <InputGroupText>
                    ...
                    <Card className="bg-secondary border-0 mb-0" lg="9">
                      ...
                      <CardBody className="px-lg-5 py-lg-5">
                        ...
                        <Row className="mb-3">
                          <Col md="12">
                            <label className="form-control-label" htmlFor="max-participant">
                              Tối thiểu nhóm đăng ký<span className="text-warning">*</span>
                            </label>
                            <InputGroup>
                              <Input
                                className="text-default"
                        ...
                        <Row>
                          <Col className="text-center" md="12">
                            <Button
                              ...
                              type="button"
                              onClick={() => {
                                console.log(minMemberInTeam, numberOfParticipations);
                                if (
                                  ...
                                  } else if (parseInt(minRequire) > parseInt(numberOfParticipations)) {
                                    warningAlert('Tối đa người đăng ký phải lớn hơn tối thiểu người đăng ký');
